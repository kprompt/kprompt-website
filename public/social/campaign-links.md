...
Gallery video: `kprompt-promo-16x9.mp4` (animated promo) · plan-deny aha: `../kprompt-plan-deny.mp4` · investigate AI SRE: `../kprompt-investigate-demo.mp4` · why: `../kprompt-why-demo.mp4` · timeline: `../kprompt-timeline-demo.mp4` · impact: `../kprompt-impact-demo.mp4` · verify: `../kprompt-verify-demo.mp4` · observe: `../kprompt-observe-demo.mp4` · IDE PlanResult: `../kprompt-ide-demo.mp4` · drift: `../kprompt-drift-demo.mp4` · multi-cluster: `../kprompt-multi-cluster-demo.mp4` · stills: `plan-demo.png`.
...
Re-render why / timeline / impact / verify / observe / ide / drift / multi-cluster: `.venv/bin/python render_clip.py why.html kprompt-why-demo` · `timeline.html kprompt-timeline-demo` · `impact.html kprompt-impact-demo` · `verify.html kprompt-verify-demo` · `observe.html kprompt-observe-demo` · `ide-planresult.html kprompt-ide-demo` · `drift.html kprompt-drift-demo` · `multi-cluster.html kprompt-multi-cluster-demo`
...
- What is Kubernetes AI: https://kprompt.ai/blog/what-is-kubernetes-ai?utm_source=x&utm_medium=social&utm_campaign=launch&utm_content=kubernetes-ai
- ImagePullBackOff: https://kprompt.ai/blog/kubernetes-imagepullbackoff?utm_source=x&utm_medium=social&utm_campaign=launch&utm_content=imagepull
- kubectl vs K9s: https://kprompt.ai/blog/kubectl-vs-k9s?utm_source=x&utm_medium=social&utm_campaign=launch&utm_content=kubectl-vs-k9s
- CrashLoopBackOff: https://kprompt.ai/blog/kubernetes-crashloopbackoff?utm_source=x&utm_medium=social&utm_campaign=launch&utm_content=crashloop
- Examples: https://github.com/kprompt/kprompt-examples?utm_source=x&utm_medium=social&utm_campaign=launch&utm_content=examples

Video file: `kprompt-demo-16x9.mp4`

## LinkedIn (company/kprompt)

- Quickstart: https://kprompt.ai/docs/quickstart?utm_source=linkedin&utm_medium=social&utm_campaign=launch&utm_content=quickstart
- What is Kubernetes AI: https://kprompt.ai/blog/what-is-kubernetes-ai?utm_source=linkedin&utm_medium=social&utm_campaign=launch&utm_content=kubernetes-ai
- ImagePullBackOff: https://kprompt.ai/blog/kubernetes-imagepullbackoff?utm_source=linkedin&utm_medium=social&utm_campaign=launch&utm_content=imagepull
- kubectl vs K9s: https://kprompt.ai/blog/kubectl-vs-k9s?utm_source=linkedin&utm_medium=social&utm_campaign=launch&utm_content=kubectl-vs-k9s
- Examples: https://github.com/kprompt/kprompt-examples?utm_source=linkedin&utm_medium=social&utm_campaign=launch&utm_content=examples

Video file: `kprompt-demo-1x1.mp4`

## Bluesky (@kprompt.bsky.social)

- Quickstart: https://kprompt.ai/docs/quickstart?utm_source=bluesky&utm_medium=social&utm_campaign=launch&utm_content=quickstart
- What is Kubernetes AI: https://kprompt.ai/blog/what-is-kubernetes-ai?utm_source=bluesky&utm_medium=social&utm_campaign=launch&utm_content=kubernetes-ai
- ImagePullBackOff: https://kprompt.ai/blog/kubernetes-imagepullbackoff?utm_source=bluesky&utm_medium=social&utm_campaign=launch&utm_content=imagepull
- kubectl vs K9s: https://kprompt.ai/blog/kubectl-vs-k9s?utm_source=bluesky&utm_medium=social&utm_campaign=launch&utm_content=kubectl-vs-k9s

## GSC — request indexing

1. https://kprompt.ai/blog/what-is-kubernetes-ai
2. https://kprompt.ai/blog/kubernetes-imagepullbackoff
