...
kprompt agent memory list -n payments --memory-backend configmap`,
      ...
      },
      {
        ...
        items: [
          ...
          "Shipped (v0.10): durable cluster / fleet outcome memory via Coordinator outcome ring + Learn bias",
          "Building: interactive Team memory / topology viewers beyond CLI artifacts",
