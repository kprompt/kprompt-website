...
export function buildLlmsFullText(): string {
  const sections: string[] = [
    ...
    "- Building / next: richer Namespace Agent fleet UX, durable Coordinator blast-radius graph, full topology Knowledge Graph, sandbox/chaos Simulation, Team org GitHub connect-repo.",
    "- Shipped Coordinator Shared Knowledge MVP: GET /v1/knowledge + `agent coordinator knowledge` over in-memory handoff edges (restart-lossy; see /docs/coordinator-knowledge).",
