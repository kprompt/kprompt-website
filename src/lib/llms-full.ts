...
export function buildLlmsFullText(): string {
  const sections: string[] = [
    ...
    "- Building / next: richer Namespace Agent fleet UX, Coordinator blast-radius / shared knowledge, full topology Knowledge Graph, sandbox/chaos Simulation, Team org GitHub connect-repo.",
