...
export function buildLlmsFullText(): string {
  const sections: string[] = [
    ...
    "- Building / next: richer Namespace Agent fleet UX, full continuous Coordinator blast-radius product graph, full topology Knowledge Graph, sandbox/chaos Simulation, Team org GitHub connect-repo (ADR-0019 accepted; A-061…A-066).",
