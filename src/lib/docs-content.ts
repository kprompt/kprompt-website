    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Not a continuous full-cluster Knowledge Graph of Secrets/external APIs — MVP+ includes service graph + Ingress/PVC + impact + memory deps (docs/graph)",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Knowledge Graph = service graph + Ingress/PVC + impact + memory deps; Secrets/external-API topology UI still building; Simulation MVP = change preview (docs/simulation)",
