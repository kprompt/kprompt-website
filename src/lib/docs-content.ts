    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Incident suggest packs: OOM memory bump, CrashLoop rollback (prior RS), ImagePull patch when the prompt names a replacement tag — still approve-gated",
      ...
      },
      {
        type: "ul",
        items: [
          "Richer incident suggest packs (more CrashLoop / ImagePull / probe failure recipes beyond conservative defaults)",
