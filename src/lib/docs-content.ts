    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "GitHub Integration MVP: --gitops opens a GitHub PR instead of cluster apply (docs/gitops-pr); Team SCM + CI ingest A-061…A-065 shipped — Checks UI A-066 still Building",
        ],
      },
      {
        type: "p",
      ...
      },
      {
        ...
        items: [
          ...
          "Team PR Checks PlanResult UI (A-066; A-061…A-065 SCM + CI ingest Done)",
