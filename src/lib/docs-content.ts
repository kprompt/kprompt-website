    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "GitHub Integration MVP: --gitops opens a GitHub PR instead of cluster apply (docs/gitops-pr); Team App install A-061 shipped — repos/CI Checks A-062+ still Building",
        ],
      },
      {
        type: "p",
      ...
      },
      {
        ...
        items: [
          ...
          "Team org repos + CI PlanResult bridges (A-062…A-066; A-061 App install metadata Done)",
