    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "GitHub Integration MVP: --gitops opens a GitHub PR instead of cluster apply (docs/gitops-pr); Team SCM A-061…A-066 shipped (/ci viewer) — Checks annotate write-back still Building",
        ],
      },
      {
        type: "p",
      ...
      },
      {
        ...
        items: [
          ...
          "GitHub Checks annotate write-back via App JWT (follow-up after A-066 viewer)",
