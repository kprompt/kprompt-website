    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "GitHub Integration MVP: --gitops opens a GitHub PR instead of cluster apply (docs/gitops-pr); Team App install + repos A-061…A-063 shipped — pipelines/CI Checks A-064+ still Building",
        ],
      },
      {
        type: "p",
      ...
      },
      {
        ...
        items: [
          ...
          "Team pipelines + CI PlanResult bridges (A-064…A-066; A-061…A-063 App install + repos Done)",
