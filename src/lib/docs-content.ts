    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Not a continuous full-cluster Knowledge Graph of Secrets/PVCs/external APIs — MVP is service graph + impact + memory deps (docs/graph)",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Coordinator — cross-ns handoff + optional kube probe + Shared Knowledge MVP (/v1/knowledge); mutate off (durable blast-radius graph still building)",
      ...
      },
      {
        ...
        items: [
          ...
          "Knowledge Graph MVP = service graph + impact + memory deps; full topology still building; Simulation MVP = change preview (docs/simulation)",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "GitHub Integration MVP: --gitops opens a GitHub PR instead of cluster apply (docs/gitops-pr); Team org connect-repo still building",
        ],
      },
      {
        type: "p",
      ...
      },
      {
        ...
        items: [
          ...
          "Team org GitHub connect-repo / CI PlanResult bridges (A-060…A-066)",
