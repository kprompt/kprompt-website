...
# kprompt "scale api to 3" -n staging --approve --wait`,
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Read episodes in order: Why AI SRE → Intent Compiler → PlanResult → Safety Engine → Multi-context → Investigation Graph. Earlier positioning posts (PlanResult JSON field guide, vs kubectl-ai, plan-approve) remain companions; this series goes deeper and stays chronological.",
        links: [
          {
            label: "Why AI SRE",
