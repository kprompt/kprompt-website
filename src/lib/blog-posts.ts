...
# kprompt "scale api to 3" -n staging --approve --wait`,
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Read episodes in order: Why AI SRE → Intent Compiler → PlanResult → Safety Engine → Multi-context → Investigation Graph → AI Timeline → Cluster Memory → Knowledge Graph. Earlier positioning posts (PlanResult JSON field guide, vs kubectl-ai, plan-approve) remain companions; this series goes deeper and stays chronological.",
        links: [
          {
            label: "Why AI SRE",
...
# Prefer static edges + degraded[] over a model inventing callers`,
      ...
      {
        type: "p",
        text: "Episode 10 is Autonomous SRE — and why we don’t want it yet. The series closes on the approval boundary, not a fleet of unsupervised remediations. The hub tracks the arc.",
        links: [
          {
            label: "Series hub",
            href: "/blog/building-ai-sre-in-public",
