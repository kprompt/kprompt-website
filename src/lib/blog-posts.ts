...
# kprompt "scale api to 3" -n staging --approve --wait`,
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Read episodes in order: Why AI SRE → Intent Compiler → PlanResult → Safety Engine → Multi-context → Investigation Graph → AI Timeline. Earlier positioning posts (PlanResult JSON field guide, vs kubectl-ai, plan-approve) remain companions; this series goes deeper and stays chronological.",
        links: [
          {
            label: "Why AI SRE",
...
# Prefer reading JSON timeline[] before any suggested mutate`,
      ...
      {
        type: "p",
        text: "Episode 8 is Cluster Memory — durable local facts that bias planning without becoming sole proof. The hub tracks the rest of the arc.",
        links: [
          {
            label: "Series hub",
            href: "/blog/building-ai-sre-in-public",
