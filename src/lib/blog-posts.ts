...
Apply? [y/N]`,
      ...
      {
        type: "p",
        text: "If you leave this page thinking “another AI wrapper,” we failed. If you leave thinking “a new infrastructure layer with a refuse-able plan,” we are pointed the right way. If you are comparing us to agent platforms that host workloads on Kubernetes (for example McKinsey’s ARK), read the dedicated comparison — same word “runtime,” different job.",
        links: [
          {
...
# Observe path: correlate + score; Autopilot stays propose-only`,
      ...
      {
        type: "p",
        text: "We do not ship a Kagent/ARK-class multi-agent application platform. Our optional in-cluster path is Observe-first and propose-first for Autopilot. If you need Teams, A2A, and a marketplace of agents as CRDs, that is ARK’s lane.",
        links: [
          {
